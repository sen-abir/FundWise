...
function ChatWidget() {
  ...
  return (
    <div>
      {open && (
        <div
          className="fixed bottom-24 left-6 md:left-auto md:right-8 w-[320px] glass p-3 rounded-xl shadow-lg z-[200]"
          role="dialog"
      ...
      <button
        className="fixed bottom-6 left-6 md:left-auto md:right-8 btn-primary z-[200]"
        onClick={() => setOpen((o) => !o)}
